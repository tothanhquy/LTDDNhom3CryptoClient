...
public class BinhTransactionHistoryAdapter extends RecyclerView.Adapter<BinhTransactionHistoryAdapter.ViewHolderCustom> {
    ...
    @NonNull
    @Override
    public BinhTransactionHistoryAdapter.ViewHolderCustom onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BinhTransactionHistoryAdapter.ViewHolderCustom(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.binh_item_balance_transaction, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull BinhTransactionHistoryAdapter.ViewHolderCustom holder, int position) {
        try {
